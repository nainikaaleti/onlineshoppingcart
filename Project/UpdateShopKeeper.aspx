<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateShopKeeper.aspx.cs" Inherits="UpdateShopKeeper" MasterPageFile="~/InnerMaster.master"%>
<asp:Content ID="Updateshop" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">

    <table class="style1" style="width: 500px; height: 442px">
            <tr>
              <td align="right" colspan="3">
                  <asp:Label ID="Label12" runat="server" Font-Bold="true" Text="Welcome :"></asp:Label>
                  <asp:Label ID="Label13" runat="server" Text="Label"></asp:Label>
              </td>
            </tr>
            <tr>
                <td colspan="3" align="center">
                    Update ShopKeeper</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
                        ControlToValidate="TextBox6" ErrorMessage="Enter Shop Name"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="style2" style="width: 173px">
                ...
                <td class="style3">
                    <asp:TextBox ID="TextBox7" runat="server" TextMode="MultiLine" Width="127px"></asp:TextBox>
                </td>
                <td>
            ...
            <tr>
                <td class="style4" style="width: 173px">
            ...
            <tr>
                ...
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" 
                        ControlToValidate="TextBox9" ErrorMessage="Enter Answer"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
